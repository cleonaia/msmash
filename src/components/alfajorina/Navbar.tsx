        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/alfajorina/pedidos"
                className={`relative flex items-center justify-center w-10 h-10 rounded-full border transition-colors duration-200
                  ${scrolled || !isHome
                    ? "border-alfe-border text-alfe-choco-mid hover:border-alfe-caramel hover:text-alfe-caramel"
                    : "border-white/40 text-white hover:border-white hover:bg-white/10"
                  }`}
              ...
              >
                <ShoppingBag className="h-4 w-4" />
                {totalItems > 0 && (
                  <span className="absolute -top-1 -right-1 flex h-4 w-4 items-center justify-center rounded-full bg-alfe-caramel text-[9px] font-black text-white">
                    {totalItems}
                  </span>
                )}
              </Link>
