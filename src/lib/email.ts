  ...
  try {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f5f5f5; padding: 20px;">
      ...
      <div style="background: white; padding: 30px; border-radius: 0 0 10px 10px;">
        ...
        <p style="color: #666; line-height: 1.6; margin: 20px 0;">
          ...
          📧 <strong>msmashburguer2026@gmail.com</strong>
        </p>
    ...
    if (useResend && resend) {
      const result = await resend.emails.send({
        from: 'Smash Burger <msmashburguer2026@gmail.com>',
      ...
      const result = await transporter.sendMail({
        from: process.env.SMTP_FROM || 'msmashburguer2026@gmail.com',
        to: data.customerEmail,
        subject: `✅ Pedido confirmado #${data.orderId.slice(-8)}`,
        html: emailContent
      })
      ...
      <div style="background: white; padding: 30px; border-radius: 0 0 10px 10px;">
        ...
        <div style="background: #fff3cd; padding: 15px; border-left: 4px solid #ff6b6b; margin: 20px 0; border-radius: 4px;">
          <p style="margin: 0; color: #856404;">
            ...
            4️⃣ Envía un email a: msmashburguer2026@gmail.com
          </p>
        </div>
